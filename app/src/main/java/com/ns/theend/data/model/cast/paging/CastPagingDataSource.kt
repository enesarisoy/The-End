...
class CastPagingDataSource(
...
) : PagingSource<Int, CastResult>() {

    override fun getRefreshKey(state: PagingState<Int, CastResult>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CastResult> {
